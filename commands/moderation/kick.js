...
$channelSendMessage[$channelID;{title:**$username[$mentioned[1]]** has been Kicked by $username}{color:ff00ff}]
...
$onlyPerms[kick;{title:Missing Permissions}{color:ff00ff}{title:You don't have **Kick Members** permissions to use this command}]
