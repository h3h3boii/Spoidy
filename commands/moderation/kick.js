...
$channelSendMessage[$channelID;{title:**$username[$mentioned[1]]** has been Kicked by $username}{color:$getVar[embedc]}]
...
$onlyPerms[kick;{title:Missing Permissions}{color:$getVar[embedc]}{title:You don't have **Kick Members** permissions to use this command}]
