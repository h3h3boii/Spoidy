...
$channelSendMessage[$channelID;{title:**$username[$mentioned[1]]#$discriminator[$mentioned[1]]** has been sucesfully muted for $replaceText[$replaceText[$checkCondition[$noMentionMessage[1]==];true;undefined time];false;$noMentionMessage[1]]}{color:ffffff}]
...
$onlyPerms[managemessages;{title:Missing Permissions}{color:ffffff}{description:You don't have \`MANAGE_MESSAGES\` permissions to use this command}]
`
};
