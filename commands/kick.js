...
$channelSendMessage[$channelID;{title:**$username[$mentioned[1]]** has been Kicked by $username}{color:b200ff}]
...
$onlyPerms[kick;{title:Missing Permissions}{color:b200ff}{title:You don't have **Kick Members** permissions to use this command}]
